...
if ($category) {
    ...
    $stmt = $conn->prepare("SELECT listing_id, title, price, image FROM listing WHERE category = ? ORDER BY listing_id DESC");
    ...
    <div class="content">
        ...
        <div class="products-grid">
            <?php if (empty($listings)): ?>
                <p style="text-align:center; color:#999;">No products found in this category.</p>
            <?php else: ?>
